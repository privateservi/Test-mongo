...
# MongoDB information
DATABASE_URI = [int(ch) for ch in (environ.get('DATABASE_URI', 'mongodb+srv://smdfiletertest:smdfiletertest10@cluster0.bfkvuuf.mongodb.net/?retryWrites=true&w=majority mongodb+srv://smdfiletolink:smdfiletolink10@cluster0.ta94doi.mongodb.net/?retryWrites=true&w=majority')).split()]
